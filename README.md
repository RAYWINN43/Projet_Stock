...
| Notifications| - Envoyer des notifications à certains seuils de stockage <br> - Planifier des notifications lorsqu'un produit devient disponible ou indisponible <br> - Envoyer des notifications relatives à des changements d'état |
